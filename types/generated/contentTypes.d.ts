...
export interface ApiCommonCommon extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    cookieContent: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    head: Schema.Attribute.Component<'common.page-information', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    homePageDesc: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    landingPageDesc: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    logoMini: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    poweredByImages: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    poweredByLabel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
  ...
  attributes: {
    ...
    content: Schema.Attribute.DynamicZone<
      [
        ...
        'zones.image-content',
        'zones.video-content',
        'zones.gallery-content',
        'zones.title-content',
        'zones.accordion-content',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
